...
// start/end: AABB top-left-space endpoints (typically mid-left → mid-right).
...
// Default start/end in AABB top-left space: mid-left → mid-right
// ((0, h/2) → (w, h/2)). Falls back to (0,0)→(100,0). Returns false on fallback.
